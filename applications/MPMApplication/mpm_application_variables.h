...
namespace Kratos
{
    ...
    KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(MPM_APPLICATION, MP_BODY_FORCE )
    ...
    // Hacks because of how we store internal variables. To be changed
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(MPM_APPLICATION, double, TANGENTIAL_PENALTY_COEFFICIENT)
