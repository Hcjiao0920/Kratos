...
namespace Python{
    ...
    PYBIND11_MODULE(KratosMPMApplication, m)
    {
        ...
        KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, MP_BODY_FORCE);
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SAND_HYPOPLASTIC_PARAMETERS);
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TANGENTIAL_PENALTY_COEFFICIENT);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FRICTION_ACTIVE);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FRICTION_ASSIGNED);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HAS_INITIAL_MOMENTUM);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INITIAL_LOOP_COMPLETE);
    }
